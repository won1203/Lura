package com.won1203.lura.playback
...
import com.won1203.lura.data.ScheduledAlarmResult
...
class SleepPlaybackService : MediaSessionService() {
    ...
    companion object {
        const val ACTION_START = "com.won1203.lura.playback.action.START"
        const val ACTION_START_FOR_ALARM = "com.won1203.lura.playback.action.START_FOR_ALARM"
