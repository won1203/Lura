...
class AlarmEventReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_ALARM_EVENT = "com.won1203.lura.alarm.action.EVENT"
        const val ACTION_START_SLEEP_PLAYBACK =
            "com.won1203.lura.alarm.action.START_SLEEP_PLAYBACK"
        const val ACTION_DISABLE_SLEEP_ALARM =
            "com.won1203.lura.alarm.action.DISABLE_SLEEP_ALARM"
